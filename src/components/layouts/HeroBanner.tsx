...
const HeroBanner: NextPage = () => {
  ...
  return (
    <section
      id='hero'
      className='bg-light-primary dark:bg-dark py-12 md:flex md:justify-around md:items-center h-[70vh] md:h-screen'
    >
      <motion.div
      ...
      >
        <div className=' mb-12 '>
          <span className='text-highlight-dark font-content text-2xl lg:text-4xl'>
            Hello, my name is
          </span>
          <h1
            className={`font-headline text-light-heading dark:text-[#E3E3E1] font-bold text-5xl md:text-9xl pb-4 ${
              theme === 'dark' ? 'neon' : 'light-heading-stroke'
            }`}
          >
            Yuto Yamakita
          </h1>
