...
const HeroBanner: NextPage = () => {
  ...
  return (
    <Fragment>
      ...
      >
        <div className=' mb-12 '>
          <span className='text-headline-dark font-content text-2xl'>Hello, my name is</span>
          <h1 className=' neon font-headline text-[#E3E3E1] font-bold text-6xl md:text-8xl'>Yuto Yamakita</h1>
