...
const HeroBanner: NextPage = () => {
  ...
  return (
    <section id='hero' className='bg-light-primary dark:bg-dark py-12 md:flex md:justify-around md:items-center h-screen snap-start'>
      <motion.div
      ...
      >
        <div className=' mb-12 '>
          ...
          <h1 className=' neon font-headline text-light-heading dark:text-[#E3E3E1] font-bold text-5xl md:text-9xl pb-4'>
            Yuto Yamakita
          </h1>
